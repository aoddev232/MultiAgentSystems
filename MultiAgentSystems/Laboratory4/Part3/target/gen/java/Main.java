		...
		addRule(new Rule(
			...
			new Block(
				...
				new Statement[] {
					...
					new ForAll(
						"Main", new int[] {13,8,13,40},
						new Variable(Type.STRING, "entity",false),
						new Variable(Type.LIST, "entities"),
						new Block(
							"Main", new int[] {13,41,22,5},
							new Statement[] {
								new ModuleCall("S",
									"Main", new int[] {14,12,14,43},
					...
					new ModuleCall("S",
						"Main", new int[] {20,8,20,22},
						new Predicate("sleep", new Term[] {
							Primitive.newPrimitive(100000)
						}),
						new DefaultModuleCallAdaptor() {
							public boolean inline() {
								return false;
